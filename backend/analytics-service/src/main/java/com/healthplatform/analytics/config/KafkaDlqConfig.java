 ...
 * catch-and-log-only consumer code). analytics-service has no Kafka producer of its own, so
 * this is the first producer config in this service — dedicated to DLQ publishing only.
 */
@Configuration
